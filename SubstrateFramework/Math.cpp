...
template<class type>
static Mat3x3<type> Mat3x3<type>::getRotX(type thetaDeg)
{
...
template<class type>
static Mat3x3<type> Mat3x3<type>::getRotY(type thetaDeg)
{
	type thetaRad = thetaDeg * PI / 180.f;
	Mat3x3<type> mout;
...
template<class type>
static Mat3x3<type> Mat3x3<type>::getRotZ(type thetaDeg)
{
	type thetaRad = thetaDeg * PI / 180.f;
	Mat3x3<type> mout;
	mout.element[0][0] = cos(thetaRad);
